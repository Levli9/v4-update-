...
const DETAILED_OFFLINE_COURSES = {
  ...
  0: {
    ...
    quiz: [
      {
        id: "intro-cyber-1",
        question: "מהי המטרה המרכזית של מתקפת סייבר?",
        answers: [
          "לשפר את מהירות המחשב",
          "לפגוע בסודיות, בשלמות או בזמינות של מידע ומערכות",
          "לעדכן תוכנות באופן אוטומטי",
          "להגדיל את נפח האחסון בענן"
        ],
        correctIndex: 1,
        explanation: "מתקפת סייבר מנסה לפגוע באחד או יותר מעקרונות אבטחת המידע: סודיות, שלמות וזמינות."
      },
      {
        id: "intro-cyber-2",
        question: "איזה עיקרון ב-CIA Triad מבטיח שרק אנשים מורשים יוכלו לראות מידע?",
        answers: ["סודיות (Confidentiality)", "שלמות (Integrity)", "זמינות (Availability)", "גיבוי (Backup)"],
        correctIndex: 0,
        explanation: "סודיות מגינה על המידע מפני חשיפה לא מורשית."
      },
      {
        id: "intro-cyber-3",
        question: "קובץ ששונה ללא הרשאה פוגע בעיקר באיזה עיקרון?",
        answers: ["סודיות", "שלמות", "זמינות", "הצפנה"],
        correctIndex: 1,
        explanation: "שלמות פירושה שהמידע נשאר מדויק ולא השתנה ללא הרשאה."
      },
      {
        id: "intro-cyber-4",
        question: "איזה סוג תוקף פועל בדרך כלל מתוך מטרה של רווח כספי?",
        answers: ["האקטיביסט", "פושע סייבר", "משתמש מורשה", "צוות תמיכה"],
        correctIndex: 1,
        explanation: "פושעי סייבר מבצעים למשל גניבת מידע וכופרה כדי להרוויח כסף."
      },
      {
        id: "intro-cyber-5",
        question: "מהו צעד נכון ראשון במקרה של הודעה או קישור חשודים?",
        answers: [
          "ללחוץ על הקישור כדי לבדוק מה יש בו",
          "להעביר את ההודעה לכל אנשי הקשר",
          "לא ללחוץ, לבדוק את המקור ולדווח לגורם המתאים",
          "להשיב מיד עם פרטים אישיים"
        ],
        correctIndex: 2,
        explanation: "עצירה, בדיקת המקור ודיווח מצמצמים את הסיכוי ליפול במתקפת פישינג או הונאה אחרת."
      }
    ]
  },
