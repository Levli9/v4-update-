...
import { Check, Clock3, Copy, Eye, EyeOff, KeyRound, Lock, ShieldCheck, Star, UserCheck, UserX, X } from 'lucide-react';
...
export default function AdminApprovals() {
  const { users, currentUser, reviewRegistration, getBrevoConfig, saveBrevoConfig } = useApp();
