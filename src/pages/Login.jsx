        ...
        {activeTab === 'login' && (
          <form className="mt-6 space-y-6" onSubmit={handleLoginSubmit}>
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#080d18] px-2 text-gray-500 font-semibold">או</span></div>
            </div>

            <button
              type="button"
              onClick={handleGoogleLogin}
              className="w-full py-3 px-4 rounded-xl border border-gray-700 bg-gray-900/60 hover:bg-gray-800 text-white font-bold text-sm transition-all flex items-center justify-center gap-3 shadow-md"
            >
